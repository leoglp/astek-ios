...
class TechnicalSkillViewController: UIViewController {
    ...
    private func createValueInDB(){
        DatabaseUtil.addValueInDataBase(valueToAdd: generateValueForDB(),collectionToCreate: "technicalSkillEvaluation")
    }
    
    
    private func updateValueInDB(){
        DatabaseUtil.updateValueInDataBase(valueToUpdate: generateValueForDB(),collectionToUpdate: "technicalSkillEvaluation",documentUpdateId: documentUpdateId)
    }
