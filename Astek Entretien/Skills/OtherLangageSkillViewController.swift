...
class OtherLangageSkillViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        className = NSStringFromClass(OtherLangageSkillViewController.classForCoder())
    ...
    private func createValueInDB(){
        DatabaseUtil.addValueInDataBase(valueToAdd: generateValueForDB(),collectionToCreate: "othersSkillEvaluation")
    }
    
    
    private func updateValueInDB(){
        DatabaseUtil.updateValueInDataBase(valueToUpdate: generateValueForDB(),collectionToUpdate: "othersSkillEvaluation",documentUpdateId: documentUpdateId)
    }
...
extension OtherLangageSkillViewController: UITextFieldDelegate {
...
extension OtherLangageSkillViewController {
