...
class AutonomousSkillViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        className = NSStringFromClass(AutonomousSkillViewController.classForCoder())
    ...
    private func createValueInDB(){
        DatabaseUtil.addValueInDataBase(valueToAdd: generateValueForDB(),collectionToCreate: "autonomySkillEvaluation")
    }
    
    
    private func updateValueInDB(){
        DatabaseUtil.updateValueInDataBase(valueToUpdate: generateValueForDB(),collectionToUpdate: "autonomySkillEvaluation",documentUpdateId: documentUpdateId)
    }
...
extension AutonomousSkillViewController: UITextFieldDelegate {
...
extension AutonomousSkillViewController {
