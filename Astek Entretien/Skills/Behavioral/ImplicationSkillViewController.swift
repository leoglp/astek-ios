...
class ImplicationSkillViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        className = NSStringFromClass(ImplicationSkillViewController.classForCoder())
    ...
    private func createValueInDB(){
        DatabaseUtil.addValueInDataBase(valueToAdd: generateValueForDB(),collectionToCreate: "implicationSkillEvaluation")
    }
    
    
    private func updateValueInDB(){
        DatabaseUtil.updateValueInDataBase(valueToUpdate: generateValueForDB(),collectionToUpdate: "implicationSkillEvaluation",documentUpdateId: documentUpdateId)
    }
...
extension ImplicationSkillViewController: UITextFieldDelegate {
...
extension ImplicationSkillViewController {
