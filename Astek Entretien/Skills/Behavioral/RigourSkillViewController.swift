...
class RigourSkillViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        className = NSStringFromClass(RigourSkillViewController.classForCoder())
    ...
    private func createValueInDB(){
        DatabaseUtil.addValueInDataBase(valueToAdd: generateValueForDB(),collectionToCreate: "rigourSkillEvaluation")
    }
    
    
    private func updateValueInDB(){
        DatabaseUtil.updateValueInDataBase(valueToUpdate: generateValueForDB(),collectionToUpdate: "rigourSkillEvaluation",documentUpdateId: documentUpdateId)
    }
...
extension RigourSkillViewController: UITextFieldDelegate {
...
extension RigourSkillViewController {
