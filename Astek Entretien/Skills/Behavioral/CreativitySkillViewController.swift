...
class CreativitySkillViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        className = NSStringFromClass(CreativitySkillViewController.classForCoder())
...
extension CreativitySkillViewController: UITextFieldDelegate {
...
extension CreativitySkillViewController {
