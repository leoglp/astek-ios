//
//  ManagerAppreciationViewController.swift
//  Astek Entretien
//
...
class ManagerAppreciationViewController: UIViewController {
    ...
    private func createValueInDB(){
        ...
        DatabaseUtil.addValueInDataBase(valueToAdd: managerAppreciation,collectionToCreate: "managerAppreciation")
    }
    ...
    private func updateValueInDB(){
        ...
        DatabaseUtil.updateValueInDataBase(valueToUpdate: managerAppreciation,collectionToUpdate: "managerAppreciation",documentUpdateId: documentUpdateId)
    }
    ...
    private func initText() {
        ...
        if(!AuthenticationUtil.isManager) {
            gainText.isEnabled = false
            gainText.backgroundColor = UIColor.gray
            improveText.isEnabled = false
            improveText.backgroundColor = UIColor.gray
            weaknessText.isEnabled = false
            weaknessText.backgroundColor = UIColor.gray
        }
    }
...
extension ManagerAppreciationViewController: UITextFieldDelegate {
...
extension ManagerAppreciationViewController {
